...
class XMLDialectInfo:
    ...
    def getMessage(self, id=None, name=None):
        ...
        if id:
            ...
            message_by_id_dict = {value['id']: value for key, value in message_by_name_dict.items()}
    ...
    def getEnumEntriesId(self, name):
        ...
        """
        enum_entries_by_name_dict = self.dict['xml_dialects'][self.dialect]['enums'][name]['entries']
        enum_entries_by_id_dict = {value['value']: value for key, value in enum_entries_by_name_dict.items()}
    ...
    def getCommandById(self, id):
        ...
        command_entries_by_name_dict = self.dict['xml_dialects'][self.dialect]['commands']
        command_entries_by_id_dict = {value['value']: value for key, value in command_entries_by_name_dict.items()}

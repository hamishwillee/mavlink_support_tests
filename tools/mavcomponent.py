...
class MAVComponent:
    ...
    def _handle_autopilot_version(self,message_dict):
        ...
        self.msg_autopilot_version['middleware_sw_version'] = f"{major_version}.{minor_version}.{patch_version}" # Done
        ...
        self.msg_autopilot_version['board_version'] = message_dict['board_version'] # comes from https://github.com/PX4/PX4-Bootloader/blob/main/board_types.txt and Ardupilot's board_version.txt
    ...
    def _messageArrived(self, msg):
        ...
        # TODO Eliminate any messages not intended for this component
